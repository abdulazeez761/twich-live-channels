let clinetId = "6gtf9dppwxbk6txcpj7wa6gdprmtks";
let clinetSecret = "tkstvwq7tu665t843c38b43wb7gkyh";
function getTwitchAuthorization() {
 ...
 async function getStreams() {
     const endpoint = "https://api.twitch.tv/helix/streams?first=5";
 ...
 function renderStreams(data) {
     ...
     for(let i =0; i<streams.length; i++){
          // console.log(streams[i].language)
    ...
    <div class="stream-container">
         ...
         <p>
             ...
             ${viewer_count.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} watching
         </p>
     </div>
     `;
     });
